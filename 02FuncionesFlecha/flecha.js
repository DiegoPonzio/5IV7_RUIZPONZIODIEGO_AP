/*
Una funcion flecha es una funcion JS, que a duferenca de una normal, no genera su propio contexto(this)
necesita ser declarada antes de ser usada, y no necesitan usar "return" o llaves para instrucciones de una sola
...
/*
si queremos devolver un objeto en una sola linea con una funcion flecha
debemos envolverlo primero entre parentesis
*/
...
/*cuando la funcion flecha tiene un solo paramero no es necesario envolverlo entre parentesis*/
